        ...
        <div class="col mb-3">
          <div class="card">
            ...
            <div class="card-footer">
              <button href="/protfolio/details/{{$user->id}}" class="btn btn-light btn-sm bg-white has-icon btn-block" type="button"><i class="material-icons"></i></button>
              ...
              <a style="text-decoration: none;" href="/Manager/details/{{$user->id}}">Details</a>
            </div>
          </div>
