    ...
    <div class="main-body">
          ...
          <nav aria-label="breadcrumb" class="main-breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="/list/{{$user->id}}">User</a></li>
          ...
          <div class="row gutters-sm">
            ...
            <div class="col-md-8">
              ...
              <button   type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal">Delete</button>
               @if($user->active =='1')
              <a class="btn btn-warning "   target="__blank" href="/suspend/{{$user->id}}">Suspend</a>
                  @else
                 <a class="btn btn-primary "  target="__blank" href="/active/{{$user->id}}">Active</a>
                  @endif
                    </div>
                  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger"><a style="text-decoration: none; color: white" href="/delete/{{$user->id}}">Delete</a></button>
      </div>
    </div>
  </div>
</div>
