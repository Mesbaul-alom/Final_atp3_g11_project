...
<div class="container">
  ...
  <iframe  class="card-img-top" src="{{('/protfolio_img/'.$buyer['contest_file'])}}" height="150px" width="30px;" alt="Card image cap">
  </iframe>
  <div class="card-body">
    <h5 class="card-title">{{$buyer['title']}}</h5>
    <p class="card-text">{{$buyer['discription']}}</p>
    <a class="btn btn-primary" href="/postProject/details/{{$buyer['id']}}">Details</a>
	<a class="btn btn-primary" href="/postProject/edit/{{$buyer['id']}}">Edit</a>
